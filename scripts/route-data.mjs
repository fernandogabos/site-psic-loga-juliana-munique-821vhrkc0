...
export const routes = [
  ...
  },
  {
    ...
    description: 'Entenda a origem da carência afetiva, como ela se manifesta nos seus relacionamentos e por que a psicoterapia é o caminho para a autonomia emocional.',
    ogType: 'article',
  },
  {
    path: '/blog/bloqueios-emocionais-como-identifica-los',
    title: 'Bloqueios Emocionais? Como identificá-los? | Juliana Munique',
    description: 'Aprenda a reconhecer os bloqueios emocionais, defesas silenciosas do inconsciente que sabotam suas escolhas, e descubra como a terapia auxilia no desbloqueio.',
    ogType: 'article',
  },
  {
    path: '/blog/por-que-educar-e-dificil',
    title: 'Por que Educar é Difícil? | Juliana Munique',
    description: 'Reflexões sobre os desafios da parentalidade moderna, a repetição inconsciente de padrões herdados e os cinco pilares essenciais para o desenvolvimento infantil.',
    ogType: 'article',
  },
  {
    path: '/blog/funcao-materna-e-a-clinica',
    title: 'Função Materna e a Clínica | Juliana Munique',
    description: 'Compreenda como o psicólogo exerce uma função materna na clínica, acolhendo o paciente sem julgamento e oferecendo um espaço seguro para a transformação.',
    ogType: 'article',
  },
  {
    path: '/blog/fobia-social',
    title: 'Fobia Social | Juliana Munique',
    description: 'Conheça os sintomas da fobia social, saiba diferenciar da timidez comum e entenda como a psicoterapia pode ajudar a superar o medo paralisante do julgamento.',
    ogType: 'article',
  },
]
