    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <Button
            asChild
            className="rounded-full px-6 bg-primary text-primary-foreground hover:bg-primary/90 transition-transform hover:scale-105 shadow-md"
          >
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-background border-b border-border shadow-lg animate-fade-in-down max-h-[80vh] overflow-y-auto">
          <nav className="flex flex-col p-6 space-y-2">
            ...
            <div className="pt-4">
              <Button
                asChild
                className="w-full rounded-full h-12 bg-primary text-primary-foreground text-base shadow-md"
              >
                <Link to="/contato">Agendar Conversa</Link>
              </Button>
            </div>
